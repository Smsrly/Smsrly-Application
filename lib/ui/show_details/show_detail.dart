  ...
  Widget infoRow(String iconLocation , String text){
    return Row(
            children: [
              ...
              SizedBox(width: 3.w),
              Text(text,style:   TextStyle(color: const Color.fromRGBO(170, 169, 169, 1)
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              infoRow("assets/images/bed_icon.png", "${item.roomsNo}"),
                              infoRow("assets/images/bathtub_icon.png", "${item.bathroomsNo}"),
                              infoRow("assets/images/stairs_icon.png", "${item.floor}"),
                              infoRow("assets/images/areaa_icon.png", "${item.area}m²"),
                            ],
                          ),
                          SizedBox(height: 20.h),
                          userCard(),
